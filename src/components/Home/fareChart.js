                            ...
                            <div className="container mx-auto">
                                <div className="flex items-center mx-auto border-b pb-10 mb-10 border-gray-500 sm:flex-row flex-col">
                                    ...
                                    <div className="flex-grow text-left mt-6 sm:mt-0">
                                        ...
                                        <p>
                                            ...
                                            <span className="badge badge-sm badge-warning ml-2">₹11 for first 20 KMs after that ₹20/KM</span>
                                        </p>
                                        <p>
                                            <span className='text-sm text-gray-400'>Base Price:</span>
                                            <span className="badge badge-sm badge-info ml-2">₹50 for first 5 KMs</span>
                                        </p>
                                        <p>
                                ...
                                <div className="flex items-center mx-auto border-b pb-10 mb-10 border-gray-500 sm:flex-row flex-col">
                                    <div className="flex-grow text-left mt-6 sm:mt-0">
                                        ...
                                        <p>
                                            <span className='text-sm text-gray-400'>Charge/KM:</span>
                                            <span className="badge badge-sm badge-warning ml-2">₹13 for first 20 KMs after that ₹25/KM</span>
                                        </p>
                                        <p>
                                            <span className='text-sm text-gray-400'>Base Price:</span>
                                            <span className="badge badge-sm badge-info ml-2">₹60 for first 5 KMs</span>
                                        </p>
                                        <p>
                                            <span className='text-sm text-gray-400'>Ride Time Charge:</span>
                                            <span className="badge badge-sm badge-primary ml-2">₹1/min</span>
                                ...
                                <div className="flex items-center mx-auto border-b pb-10 mb-10 border-gray-500 sm:flex-row flex-col">
                                    ...
                                    <div className="flex-grow text-left mt-6 sm:mt-0">
                                        ...
                                        <p>
                                            <span className='text-sm text-gray-400'>Charge/KM:</span>
                                            <span className="badge badge-sm badge-warning ml-2">₹15 for first 20 KMs after that ₹30/KM</span>
                                        </p>
                                        <p>
                                            <span className='text-sm text-gray-400'>Base Price:</span>
                                            <span className="badge badge-sm badge-info ml-2">₹70 for first 5 KMs</span>
                                        </p>
                                        <p>
                                            <span className='text-sm text-gray-400'>Ride Time Charge:</span>
                                            <span className="badge badge-sm badge-primary ml-2">₹1/min</span>
                                ...
                                <div className="flex items-center mx-auto border-b pb-10 mb-10 border-gray-500 sm:flex-row flex-col">
                                    <div className="flex-grow text-left mt-6 sm:mt-0">
                                        ...
                                        <p>
                                            <span className='text-sm text-gray-400'>Charge/KM:</span>
                                            <span className="badge badge-sm badge-warning ml-2">₹18 for first 20 KMs after that ₹35/KM</span>
                                        </p>
                                        <p>
                                            <span className='text-sm text-gray-400'>Base Price:</span>
                                            <span className="badge badge-sm badge-info ml-2">₹80 for first 5 KMs</span>
                                        </p>
                                        <p>
                                            <span className='text-sm text-gray-400'>Ride Time Charge:</span>
                                            <span className="badge badge-sm badge-primary ml-2">₹1/min</span>
                                ...
                                <div className="flex items-center mx-auto sm:flex-row flex-col">
                                    ...
                                    <div className="flex-grow text-left mt-6 sm:mt-0">
                                        ...
                                        <p>
                                            <span className='text-sm text-gray-400'>Charge/KM:</span>
                                            <span className="badge badge-sm badge-warning ml-2">₹21 for first 20 KMs after that ₹40/KM</span>
                                        </p>
                                        <p>
                                            <span className='text-sm text-gray-400'>Base Price:</span>
                                            <span className="badge badge-sm badge-info ml-2">₹100 for first 5 KMs</span>
                                        </p>
                                        <p>
                                            <span className='text-sm text-gray-400'>Ride Time Charge:</span>
                                            <span className="badge badge-sm badge-primary ml-2">₹1/min</span>
